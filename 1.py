...
header = "{:<20}|{:<20}|{:<20}|{:<20} ".format("Algoritm", "Data 10", "Data 100", "Data 1000", "Data 100000")
...
for sort in sorting_functions:
    row = "{:<20}".format(sort.__name__)
    for data in test_data:
        _,ex_time = measure_time(sort, data)
        row += "|{:<20.5f}".format(ex_time)
    print(row)
